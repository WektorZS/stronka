    ...
    <section className="mb-16">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {[
          ...
          <div
            key={label}
            className="flex flex-col items-start gap-2 p-5 rounded-2xl bg-slate-50/60 border border-slate-200"
          >
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <Card className="border-slate-200 bg-slate-50/40">
          <CardContent className="p-6">
            <Badge className="bg-slate-800 text-white border-0 mb-4">
              Wybór redakcji
            </Badge>
        ...
        <Card className="border-slate-200 bg-slate-50/40">
          <CardContent className="p-6">
            <Badge className="bg-slate-700 text-white border-0 mb-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              100% bawełna, Oeko-Tex®, pranie 60°C i bardzo dobra cena.
            </p>
          </CardContent>
        </Card>
